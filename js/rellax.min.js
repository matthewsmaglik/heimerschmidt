...
(function (C, g) {
    ...
    var C = function (g, q) {
        ...
        var a = Object.create(C.prototype),
            ...
            e = [],
            u = !0,
            J = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame || window.oRequestAnimationFrame || function (d) {
        ...
        var Q = window.cancelAnimationFrame || window.mozCancelAnimationFrame ||
            clearTimeout,
            R = window.transformProp || function () {
                var d = document.createElement("div");
                if (null === d.style.transform) {
                    var c = ["Webkit", "Moz", "ms"],
                        b;
                    for (b in c)
                        if (void 0 !== d.style[c[b] + "Transform"]) return c[b] + "Transform"
                }
                return "transform"
            }();
        a.options = {
            ...
            if (a.options.wrapper && !a.options.wrapper.nodeType)
                if (g = document.querySelector(a.options.wrapper)) a.options.wrapper = g;
                    ...
                    for (d = 0; d < a.elems.length; d++) {
                        ...
                        a.options.relativeToWrapper &&
                            (h = (window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop) - a.options.wrapper.offsetTop);
                        var B = a.options.vertical ? f || a.options.center ? h : 0 : 0,
                            M = a.options.horizontal ? f || a.options.center ? a.options.wrapper ? a.options.wrapper.scrollLeft : window.pageXOffset || document.documentElement.scrollLeft || document.body.scrollLeft : 0 : 0;
                ...
                O = function () {
                    for (var d,
                        ...
                        f = d.y - e[c].baseY;
                        b = d.x - e[c].baseX;
                        null !== e[c].min && (a.options.vertical && !a.options.horizontal && (f = f <= e[c].min ? e[c].min : f), a.options.horizontal && !a.options.vertical &&
